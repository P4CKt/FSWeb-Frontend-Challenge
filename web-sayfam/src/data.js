export const trData = {
  ...
  hero: "Ben Ömürcan, junior seviyede bir geliştiriciyim ve özellikle React projelerinde Front-end ve UI kısımlarına odaklanıyorum. ",
  project: [
    {
      id: "01",
      name: "Minnet günlüğü",
  ...
  profile: {
    born: "04.08.1998",
    Address: "Kocaeli-Darıca",
    education: "Gebze Teknik Üni. MBM, 2023",
    role: "Frontend, UI",
    fme: " Sıkı bir problem çözücüyüm ve ekip çalışmasına büyük önem veriyorum.Yaratıcı çözümler bulma konusunda tutkulu olduğum kadar sonuç odaklı bir yaklaşıma da sahibim.Gelişimimi sürdürmek için kendimi sürekli eğitiyor, yeni teknolojileri öğrenmeye çalışıyorum.",
    sme: " Yeni projelerde çalışmaktan heyecan duyuyorum ve projelere katkıda bulunmaktan mutluluk duyuyorum.",
  },
};
...
export const enData = {
  ...
  github: "https://github.com/P4CKt",
  linkedin: "https://www.linkedin.com/in/omurcanuslu/",
  hero: " I'm Ömürcan, a junior developer with a focus on front-end and UI development in React. I'm a strong problem solver and place a high value on teamwork.",
  project: [
    {
      id: "01",
  ...
  profile: {
    born: "04.08.1998",
    Address: "Kocaeli-Darıca",
    education: "Gebze Technical Unv. MSE, 2023",
    role: "Frontend, UI",
    fme: "I'm passionate about finding creative solutions and also prioritize results-driven work. I'm constantly learning and striving to improve my skills and knowledge with new technologies.",
    sme: "I'm excited to work on new projects and make contributions to them.",
  },
};
